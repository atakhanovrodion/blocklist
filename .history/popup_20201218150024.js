...
unlistButtonCreate(){
    document.getElementById("btnarea").innerHTML = " <button id='unblockButton'>block site</button>";
    document.getElementById("unblockButton").addEventListener("click",unlistSite)
}
